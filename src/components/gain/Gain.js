  ...
  return (
    <div className="gain">
      <div className="gain-content">
        <h1>
          What you stand to gain as a <span>student</span>
        </h1>
        <p>
      ...
      <div className="gain-grid">
        ...
        <div className="grid c">
          ...
          <p>
            keep SAPA away by accessing job opportunities to earn while still in
            school and build your work experience history before graduation
          </p>
        </div>
      </div>
    </div>
