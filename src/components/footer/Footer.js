    ...
    <div className="container-fluid text-center text-md-left">
        <div className="row">
            ...
            <div className="col-md-3 mb-md-0 mb-3">
                ...
                <li><Link  to='/hiretalents'> Hire Talents</Link></li>
            ...
            <div className="col-md-3 mb-md-0 mb-3">
                   <ul className="list-unstyled">
                    ...
                    <h5 className="text-uppercase">Follow Us</h5>
                         ...
                         <a href="www.facebook.com"><FaFacebook className='social' /></a>
                         <a href="www.linkedin.com"><FaLinkedin className='social' /></a>
                         <a href="www.twitter.com"><FaTwitter className='social' /></a>
                         <a href="www.instagram.com"><FaInstagram className='social' /></a>
      </div>
